...
var route = function(urlObj) {
	...
	if (urlObj.pathname === "/user") {
		...
		result.type = "json";
		console.log("/source" + urlObj.pathname);
		result.content = fs.readFileSync("/source/" + urlObj.pathname);
		...
		console.log("/source/" + urlObj.pathname + ".js");
		result.content = new Function(fs.readFileSync("/source/" + urlObj.pathname + ".js"))();
	}
	return result;
};
